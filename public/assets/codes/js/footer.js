document.addEventListener("DOMContentLoaded",()=>{
  ...
  footer.innerHTML = `  
		...
		<section class="bg-danger pt-3 mt-5 text-center clearfix footer">
    <div class="container ">
      <div class="row bottom">
        <div class="col-sm-6 mb-3">
          ...
          <div class="">
            ...
            <p class="pl-3">
              <a class="white-text" href="landmark.html">Landmark</a>
            </p>
            <p class=" pl-3">
              <a class="white-text" href="jide-oki.html">Jide Oki</a>
            </p>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          ...
          <div>
            ...
            <p class=" white-text">
              <i class="fa fa-envelope-o mb-4"></i> <a class='white-text' href="mailto:remilekunelijah21997@gmail.com">Remilekuneiljah21997@gmail.com</a>
            </p>
  ...
  <marquee class="shadow-lg bg-danger text-white" style=" font-size: 17px;">
    <p behavior="none" direction="left" class="text-white text-center py-">&copy; 2018 & 2019 All rights reserved</marquee>
  </footer>
  `;
