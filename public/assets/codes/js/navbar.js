const navs = document.createElement("section");
navs.id = 'navigation';
...
navs.innerHTML =   ` <nav class="navbar navbar-expand-sm bg-danger shadow-lg fixed-top">
                <div class="container">
                        ...
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown ml-md-5">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="#" class="dropdown-item d-none text-danger" id="settings" data-target="#updateModal" data-toggle="modal"><i
